...
export function PhotoCarousel({ photos, className = "" }: PhotoCarouselProps) {
  ...
  if (!photos || photos.length === 0) {
    return (
      <div className={`bg-gray-100 rounded-lg flex items-center justify-center h-80 sm:h-[480px] ${className}`}>
          ...
          <DialogTrigger asChild>
            <div className="relative cursor-pointer group">
              <Image
                ...
                width={500}
                height={400}
                className="w-full object-contain bg-gray-50 hover:scale-105 transition-transform h-80 sm:h-[480px]"
              />
              <Button
                variant="outline"
                size="icon"
