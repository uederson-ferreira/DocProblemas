-- Script SEGURO para coordenadas simples (verifica antes de criar)
...
-- 5. Adicionar comentários para documentação (apenas se as colunas existirem)
...
-- 6. Criar índices para melhor performance (apenas se não existirem)
...
BEGIN
  ...
  RAISE NOTICE 'Execute: SELECT * FROM problems_with_simple_coordinates LIMIT 1;';
END $$;
